...
const SHEETS: { name: string; columns: { header: string; width: number }[]; sample: unknown[] }[] = [
  {
    name: "تأمین‌کنندگان",
    columns: [
      { header: "نام تأمین‌کننده", width: 26 },
      { header: "شخص رابط", width: 20 },
      { header: "تلفن", width: 18 },
      { header: "ایمیل", width: 24 },
      { header: "کشور", width: 14 },
      { header: "شهر", width: 14 },
      { header: "آدرس", width: 30 },
      { header: "توضیحات", width: 30 },
    ],
    sample: ["Ningbo Trade Co", "Mr. Wang", "+8613800000000", "sales@ningbo.example", "چین", "نینگبو", "", ""],
  },
  {
    name: "کالاها",
    columns: [
      ...
      { header: "برند", width: 16 },
      { header: "دسته", width: 16 },
      { header: "واحد", width: 10 },
      { header: "قیمت مرجع", width: 14 },
      { header: "ارز قیمت", width: 10 },
      { header: "توضیحات", width: 30 },
    ],
    sample: ["SKU-1", "قطعه A", "Bosch", "قطعات یدکی", "عدد", 51, "RMB", ""],
  },
  {
    name: "فاکتورها",
    columns: [
  ...
  },
  {
    name: "شارژ کیف‌پول",
    columns: [
      { header: "نام تأمین‌کننده", width: 24 },
      { header: "ارز", width: 8 },
      { header: "تاریخ", width: 14 },
      { header: "مبلغ", width: 16 },
      { header: "روش پرداخت", width: 14 },
      { header: "مرجع/رسید", width: 18 },
      { header: "توضیحات", width: 30 },
    ],
    sample: ["Ningbo Trade Co", "RMB", "1404/01/31", 30000, "حواله", "R-1001", ""],
  },
  {
    name: "تسویه فاکتور",
    columns: [
      { header: "شماره فاکتور", width: 18 },
      { header: "تاریخ", width: 14 },
      { header: "مبلغ از اعتبار", width: 16 },
      { header: "مرجع/رسید", width: 18 },
      { header: "توضیحات", width: 30 },
    ],
    sample: ["INV-001", "1404/01/31", 30000, "R-1001", ""],
  },
];
...
const GUIDE = [
  ["راهنمای تکمیل فایل"],
  [""],
  ["1. هر شیت را مطابق ستون‌های سطر اول پر کنید؛ نام شیت‌ها و عنوان ستون‌ها را تغییر ندهید."],
  ["2. ردیف دوم هر شیت یک نمونه است؛ قبل از بارگذاری آن را پاک یا با داده خودتان جایگزین کنید."],
  ["3. تاریخ‌ها هم شمسی (1404/01/26) و هم میلادی (2025-04-15) پذیرفته می‌شوند."],
  ["4. «شماره فاکتور» و «شماره پارت ارسال» کلید ارتباط بین شیت‌ها هستند و باید دقیقاً یکسان نوشته شوند."],
  ["5. در شیت «تخصیص اقلام به ارسال»، کد کالا باید با همان کدی که در «اقلام فاکتور» نوشته‌اید یکی باشد."],
  ["6. شیت‌های «تأمین‌کنندگان» و «کالاها» را اول پر کنید؛ اگر موردی آنجا نباشد ولی در فاکتورها/اقلام بیاید، خودکار ساخته می‌شود."],
  ["7. پرداخت به تأمین‌کننده تعلق دارد، نه به فاکتور: پولی که واقعاً واریز شده را در «شارژ کیف‌پول» بنویسید (هر واریز یک ردیف، هر روشی)."],
  ["8. در «تسویه فاکتور» بنویسید چه مقدار از اعتبار کیف‌پول تأمین‌کننده صرف هر فاکتور شد. فاکتور باید «فروشنده» داشته باشد و ارز کیف‌پول با ارز فاکتور یکی باشد."],
  ["9. تسویه هیچ فاکتوری بیشتر از مانده آن و بیشتر از اعتبار موجود کیف‌پول نمی‌شود؛ اضافه آن در کیف‌پول می‌ماند."],
  ["10. ستون‌های محاسباتی (مانده، سرشکن هزینه حمل، بهای تمام‌شده، وضعیت‌ها) لازم نیست؛ برنامه خودش حساب می‌کند."],
  ["11. اگر شماره فاکتور یا پارتی از قبل در سیستم باشد، دست‌نخورده می‌ماند و دوباره ساخته نمی‌شود."],
  ["12. فایل‌های قدیمی با شیت «پرداخت‌ها» هنوز پذیرفته می‌شوند: هر ردیف به یک شارژ کیف‌پول و بلافاصله تسویه همان فاکتور تبدیل می‌شود."],
];
