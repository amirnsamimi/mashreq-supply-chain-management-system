...
const GUIDE = [
  ...
  ["7. شیت «کالاها» را اول پر کنید؛ اگر کالایی آنجا نباشد ولی در «اقلام فاکتور» بیاید، خودکار ساخته می‌شود."],
  ["8. ستون‌های محاسباتی (مانده، سرشکن هزینه حمل، بهای تمام‌شده، وضعیت‌ها) لازم نیست؛ برنامه خودش حساب می‌کند."],
  ["9. اگر شماره فاکتور یا پارتی از قبل در سیستم باشد، دست‌نخورده می‌ماند و دوباره ساخته نمی‌شود."],
];
