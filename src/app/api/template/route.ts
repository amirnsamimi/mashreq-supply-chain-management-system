...
const GUIDE = [
  ...
  ["۶. شیت‌های «تأمین‌کنندگان» و «کالاها» را اول پر کنید؛ اگر موردی آنجا نباشد ولی در فاکتورها/اقلام بیاید، خودکار ساخته می‌شود."],
  ["۷. شیت «کالاها» را اول پر کنید؛ اگر کالایی آنجا نباشد ولی در «اقلام فاکتور» بیاید، خودکار ساخته می‌شود."],
  ["۸. ستون‌های محاسباتی (مانده، سرشکن هزینه حمل، بهای تمام‌شده، وضعیت‌ها) لازم نیست؛ برنامه خودش حساب می‌کند."],
  ["۹. اگر شماره فاکتور یا پارتی از قبل در سیستم باشد، دست‌نخورده می‌ماند و دوباره ساخته نمی‌شود."],
];
